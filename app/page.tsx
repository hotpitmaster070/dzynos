    ...
    <div className="min-h-screen bg-[#0a0a14] text-white overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl bg-[#151525] border border-white/10 rounded-2xl p-4 shadow-2xl">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="col-span-2 bg-[#0f0f1e] rounded-xl p-4"><h3 className="font-bold">Brand Redesign 2024 <span className="text-[10px] bg-violet-500/30 px-2 py-0.5 rounded">In review</span></h3><div className="grid grid-cols-4 gap-3 mt-4"><div className="text-center"><div className="h-16 bg-white/5 rounded-lg flex items-center justify-center">⬢</div><p className="text-[10px] mt-1 text-white/50">Color System</p></div><div className="text-center"><div className="h-16 bg-white/5 rounded-lg"></div><p className="text-[10px] mt-1 text-white/50">Onboarding</p></div><div className="text-center"><div className="h-16 bg-white/5 rounded-lg"></div><p className="text-[10px] mt-1 text-white/50">Hero Illustration</p></div></div></div>
      ...
      <footer className="text-center text-[10px] text-white/30 py-10">© 2024 DzynOS.com • Privacy • Terms • Security • Careers</footer>
    </div>
  )
      }
