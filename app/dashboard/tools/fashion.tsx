...
export default function FashionTool(props: any) {
  ...
  return (
    <div className="space-y-4">
      {/* 1. ВИЗУАЛ И CAD ПАНЕЛЬ ИНСТРУМЕНТОВ */}
      <div className="bg-[#11141d] border border-[#2dd4bf]/20 rounded-2xl p-4">
        ...
        <div className="flex gap-2 mb-2 px-1">
          <button type="button" onClick={function(){ setMannequinType("female") }} className={`px-3 py-1.5 rounded-full text-[11px] font-bold border ${mannequinType==="female"?"bg-white text-black border-white":"bg-white/10 text-white/60 border-white/10"}`}>♀ Female</button>
          <button type="button" onClick={function(){ setMannequinType("male") }} className={`px-3 py-1.5 rounded-full text-[11px] font-bold border ${mannequinType==="male"?"bg-white text-black border-white":"bg-white/10 text-white/60 border-white/10"}`}>♂ Male</button>
          <button type="button" onClick={function(){ setMannequinType("child") }} className={`px-3 py-1.5 rounded-full text-[11px] font-bold border ${mannequinType==="child"?"bg-white text-black border-white":"bg-white/10 text-white/60 border-white/10"}`}>Child</button>
        </div>
